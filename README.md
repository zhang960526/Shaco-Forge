...
- P0：`IN_PROGRESS`。P0-1 Upstream Baseline Freeze、P0-2 Web + Standard Composition Census、P0-3 Client↔Host Contract Census、P0-4 Authentication / Trust Surface Audit：`PASS / CLOSED`。下一步为 P0-5；整个 P0 尚未 PASS。

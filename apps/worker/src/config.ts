...
import { parseP8ActivationArgs, type P8Activation } from '@shaco-forge/contracts/p8-activation'
...
export function readWorkerConfig(env: NodeJS.ProcessEnv, argv: readonly string[] = []): WorkerConfig {
  const profileName = env.SHACO_FORGE_HARNESS_PROFILE_NAME?.trim() || 'shaco-forge'

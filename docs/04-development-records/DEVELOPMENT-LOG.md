...
本次仅修复 S3S1-IR-001：从真实 CLI/profile/bootstrap 推导 14 个 root，递归计算 505 个包身份、2398 条生产边，只物化 523 个可达目录。早期闭包解析失败、桌面启动超时、诊断并发冲突和祖先可选 peer 污染均保留在新 Evidence；隔离输出目录后，全部 18 个最终 Gate 在同一 source inventory 上重跑 PASS。新 artifact 为 b84beea0575404242b3979bd260cb3f98ed6c443ba9e71789e6f799c8f409b05。当前只等待 targeted independent re-review，Step1 未关闭、未冻结。

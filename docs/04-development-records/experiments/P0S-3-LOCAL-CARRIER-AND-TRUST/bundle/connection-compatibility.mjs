/**
 * NOT_PRODUCTION P0.S-3 non-listening Layer C compatibility service.
...
export const name = 'p0s3-connection-compatibility'
...
export default class P0S3ConnectionCompatibility extends HostConnectionService {

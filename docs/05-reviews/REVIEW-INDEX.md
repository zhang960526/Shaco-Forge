...
| REVIEW-004 | Independent P0 Closure Audit | PASS_WITH_REQUIRED_CORRECTIONS | Executor applied F-01/F-02/F-03 wording; Independent Corrective Review pending; `ALLOW_P0S = NO` | `architecture/AUDIT-004-INDEPENDENT-P0-CLOSURE.md` |
| CORRECTIVE-004 | P0 Closure F-01/F-02/F-03 wording | APPLIED | Independent Corrective Review pending; does not set `P0_CLOSURE_AUDIT = PASS` | `architecture/CORRECTIVE-004-P0-CLOSURE-F01-F02-F03.md` |
